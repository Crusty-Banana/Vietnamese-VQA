...
#load old model
checkpoint_path = '/home/LENOVO/Vietnamese-VQA/saved_model/model_2024-01-05_09-19-41.pth'
...
for data in test_dataset:
    ...
    print(id, "/", test_dataset_len)

# Write to file
file_path = '/inference/test_prdictions.json'

with open(file_path, 'w') as file:
    json.dump(predictions, file)

print(f"Dictionary is exported to {file_path}")